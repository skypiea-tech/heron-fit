...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRow>>(
      stream: _model.homeSupabaseStream ??= SupaFlow.client
          .from("users")
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                Container(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    fillColor: FlutterFlowTheme.of(context)
                                        .secondaryBackground,
                                    icon: Icon(
                                      FFIcons.kiconlyNotification1732244947995,
                                      color:
                      ...
                      Column(
                        ...
                        children: [
                          Expanded(
                            child: FutureBuilder<List<SessionsRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<SessionsRow>
                                    gymAvailabilityContainerSessionsRowList =
                                    snapshot.data!;
