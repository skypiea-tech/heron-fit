...
import 'compare_progress_photos_model.dart';
export 'compare_progress_photos_model.dart';
...
class _CompareProgressPhotosWidgetState
    extends State<CompareProgressPhotosWidget> {
  late CompareProgressPhotosModel _model;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UpdateWeightRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UpdateWeightRow> compareProgressPhotosUpdateWeightRowList =
            snapshot.data!;
                    ...
                    children: [
                      ...
                      FutureBuilder<List<UpdateWeightRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<UpdateWeightRow> carouselUpdateWeightRowList =
                              snapshot.data!;
                          ...
                          return SizedBox(
                            ...
                            child: CarouselSlider.builder(
                              itemCount: carouselUpdateWeightRowList.length,
                              itemBuilder: (context, carouselIndex, _) {
                                final carouselUpdateWeightRow =
                                    carouselUpdateWeightRowList[carouselIndex];
                                return InkWell(
                                  ...
                                  onTap: () async {
                                    _model.activethissiamgbruh =
                                        carouselUpdateWeightRow.pic;
                                    _model.weight =
                                        carouselUpdateWeightRow.weight;
                                    _model.date = carouselUpdateWeightRow.date;
                                    safeSetState(() {});
                                  },
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                              ...
                              options: CarouselOptions(
                                initialPage: max(
                                    ...
                                    min(
                                        1,
                                        carouselUpdateWeightRowList.length -
                                            1)),
