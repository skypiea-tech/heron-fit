                    ...
                    children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        buttonSize: 40.0,
                                        icon: Icon(
                                          FFIcons.kiconlyCamera1732244947962,
                      ...
                      FutureBuilder<List<UpdateWeightRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<UpdateWeightRow> buttonUpdateWeightRowList =
                              snapshot.data!;

                          return FFButtonWidget(
                            onPressed: () async {
                              _model.weightoutput =
                                  await UpdateWeightTable().insert({
