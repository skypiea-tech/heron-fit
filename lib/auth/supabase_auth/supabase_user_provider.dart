...
class HeronFitSupabaseUser extends BaseAuthUser {
  HeronFitSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> heronFitSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = HeronFitSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
