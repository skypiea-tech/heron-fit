...
import '/modals/feedback_received_modal/feedback_received_modal_widget.dart';
                ...
                children: [
                  ...
                  Builder(
                    builder: (context) => FFButtonWidget(
                      onPressed: () async {
                        _model.userFeedback = await FeedbackTable().insert({
                          'message': _model.userFeedbackTextController.text,
                          ...
                          builder: (dialogContext) {
                            return Dialog(
                              ...
                              child: GestureDetector(
                                ...
                                child: const FeedbackReceivedModalWidget(),
                              ),
                            );
                          },
                        );
