...
import '/components/program_card/program_card_widget.dart';
...
class _WorkoutDashboardWidgetState extends State<WorkoutDashboardWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TemplatesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TemplatesRow> workoutDashboardTemplatesRowList = snapshot.data!;
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Builder(
                                    builder: (context) {
                                      final workoutDashboardVar =
                                          workoutDashboardTemplatesRowList
                                              .toList();

                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: List.generate(
                                            workoutDashboardVar.length,
                                            (workoutDashboardVarIndex) {
                                          final workoutDashboardVarItem =
                                              workoutDashboardVar[
                                                  workoutDashboardVarIndex];
                                          return Expanded(
                                            child: Container(
                                                        ...
                                                        return ListView.builder(
                                                          ...
                                                          itemCount:
                                                              templateExercises
                                                                  .length,
                                                          itemBuilder: (context,
                                                              templateExercisesIndex) {
                                                            final templateExercisesItem =
                                                                templateExercises[
                                                                    templateExercisesIndex];
                                                            return Align(
                                                              alignment:
