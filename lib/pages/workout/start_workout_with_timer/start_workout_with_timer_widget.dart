...
import 'start_workout_with_timer_model.dart';
export 'start_workout_with_timer_model.dart';

class StartWorkoutWithTimerWidget extends StatefulWidget {
  const StartWorkoutWithTimerWidget({super.key});

  @override
  State<StartWorkoutWithTimerWidget> createState() =>
      _StartWorkoutWithTimerWidgetState();
}

class _StartWorkoutWithTimerWidgetState
    extends State<StartWorkoutWithTimerWidget> {
  late StartWorkoutWithTimerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StartWorkoutWithTimerModel());
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          ].addToStart(const SizedBox(width: 62.0)),
                                        ),
                                        Row(
                                          mainAxisSize: MainAxisSize.max,
                                          mainAxisAlignment:
                                        ...
                                        Theme(
                                          ...
                                          .addToStart(const SizedBox(width: 22.0)),
                                    ),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(4.0),
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          ].addToStart(const SizedBox(width: 58.0)),
                                        ),
                                        Row(
                                          mainAxisSize: MainAxisSize.max,
                                          mainAxisAlignment:
                                          ...
                                          ].addToStart(const SizedBox(width: 42.0)),
                                        ),
                                        Row(
                                          mainAxisSize: MainAxisSize.max,
                                          children: [
