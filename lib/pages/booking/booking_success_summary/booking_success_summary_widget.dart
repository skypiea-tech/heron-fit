                    ...
                    RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          const TextSpan(
                            text:
                                'Your session has been successfully booked. We look forward to seeing you at the gym.',
                            style: TextStyle(),
                          )
                        ],
                  ...
                  child: Column(
                    ...
                    children: [
                      FFButtonWidget(
                        ...
                        icon: const Icon(
                          FFIcons.kiconlyTicketStar1732244947613,
                          size: 24.0,
                        ),
                      ...
                      FFButtonWidget(
                        ...
                        icon: const Icon(
                          FFIcons.kiconlyDocument1732244947523,
                          size: 24.0,
                        ),
                        options: FFButtonOptions(
                          width: double.infinity,
